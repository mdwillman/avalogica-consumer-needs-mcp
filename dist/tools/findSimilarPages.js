...
export const findSimilarPagesTool = {
    definition: {
        ...
        description: "Given a high-signal page (article, post, thread), find other web pages that are semantically similar. Use this to explore clusters of related needs, complaints, and examples.",
        inputSchema: {
            ...
            properties: {
                url: {
                    type: "string",
                    description: "The URL of a page that looks like a strong signal about a need or problem. The tool will find semantically similar pages.",
                },
                numResults: {
                    type: "number",
                    minimum: 1,
                    maximum: 20,
                    description: "How many similar pages to retrieve (1–20). Defaults to 10 if omitted.",
                },
            },
            required: ["url"],
        },
    ...
    handler: async (args) => {
        ...
        try {
            ...
            console.error(`[AI Consumer Needs MCP] 🔍 find_similar_pages url="${trimmedUrl}" numResults=${numResults}`);
            ...
            console.error("[AI Consumer Needs MCP] ❌ find_similar_pages handler error:", error);
